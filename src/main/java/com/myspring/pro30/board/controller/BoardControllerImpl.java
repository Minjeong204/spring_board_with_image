...
public class BoardControllerImpl implements BoardController {
	 ...
	 * "<script>"; message += " alert('새글을 추가했습니다.');"; message +=
...
//	articleMap.put("fileList", fileList);
	 ...
	 * "<script>"; message += " alert('오류가 발생했습니다.다시 수정해주세요');"; message +=
	 * " location.href='" + multipartRequest.getContextPath() +
	...
	private ModelAndView replyform(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String parentNOS = NullCheck(request.getParameter("parentNO"), "");
		int parentNO = Integer.parseInt(parentNOS);
		System.out.print(parentNO);
